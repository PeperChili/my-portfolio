...
export const Home: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center pt-24 px-6 text-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center scale-80 transform-gpu origin-center">
        <motion.div
        ...
        <motion.h1
          ...
          className="text-6xl font-black tracking-tight text-black mb-4"
        >
          你好，我是虎皮尖椒
        </motion.h1>
        ...
        <motion.h2
          ...
          className="text-6xl font-black tracking-tight mb-12 bg-gradient-to-r from-blue-500 via-purple-500 to-orange-400 bg-clip-text text-transparent"
        >
          A creative creator!
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-lg text-gray-600 max-w-2xl mb-16 leading-relaxed"
        >
        ...
        >
          {tags.map((tag, i) => (
            <div
              key={i}
              className="px-8 py-4 bg-white/60 backdrop-blur-xl border border-white/40 rounded-full text-lg font-medium shadow-sm hover:shadow-md hover:bg-white/80 transition-all duration-300 cursor-default"
            >
              {tag}
            </div>
          ))}
